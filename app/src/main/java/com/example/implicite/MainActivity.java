    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(val1.isEmpty()){
                    Toast.makeText(MainActivity.this, "veillez entrer une text", Toast.LENGTH_SHORT).show();
                }else{
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(val2.isEmpty()){
                    Toast.makeText(MainActivity.this, "veillez entrer une location", Toast.LENGTH_SHORT).show();
                }else{
                    String geo = "geo:"+val2;
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(val3.isEmpty()){
                    Toast.makeText(MainActivity.this, "veillez entrer une number", Toast.LENGTH_SHORT).show();
        ...
        btn5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(val4.isEmpty()){
                    Toast.makeText(MainActivity.this, "veillez entrer une contact", Toast.LENGTH_SHORT).show();
